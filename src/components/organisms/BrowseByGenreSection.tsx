...
import { Church, Music, Heart, Flame, Mic2, Disc3, Sparkles, Music4, Ellipsis } from "lucide-react";
...
const mainGenres = [
  ...
  // NEW GENRES
  { name: "Instrumental", color: "bg-[#7A3E1C]", icon: Music4 },
  { name: "More Genres", color: "bg-gray-200", icon: Ellipsis },
];
