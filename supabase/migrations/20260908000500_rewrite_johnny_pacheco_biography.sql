...
--
-- DOS PARENTESCOS DOCUMENTADOS QUE NO SE REGISTRAN, Y POR QUÉ. El Instituto de
...
-- HERNÁNDEZ desciende de una tía bisabuela suya. Los dos están publicados. Pero
-- artist_family_relationships solo admite siete tipos y el más flojo es
-- 'cousin': meter ahí un primo segundo del segundo grado o una prima cuarta
-- diría algo bastante más cercano de lo que la fuente sostiene. Queda reportado
-- para que lo decida el editor.
--
...
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'johnny-pacheco') AND locale = 'en'), '03866ef4-d190-4284-b311-2958e5fa8ecd', 'artist', 'e8ba0f32-1d96-494d-9861-b1dc3937331e');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'johnny-pacheco') AND locale = 'en'), '45a27c2c-9583-4ebf-96aa-a228eb125117', 'artist', '439a9467-df91-459c-9c87-aa8640b780f8');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'johnny-pacheco') AND locale = 'en'), 'ae7b60ff-d947-4c58-9e13-58c1d11388f6', 'artist', 'dc89c826-c298-48c8-aa05-50e77d85264a');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'johnny-pacheco') AND locale = 'es'), '49be41af-e365-4574-a431-73f0ec8942c8', 'artist', '439a9467-df91-459c-9c87-aa8640b780f8');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'johnny-pacheco') AND locale = 'es'), 'a4bfa3e5-c21a-43e2-80a1-e89e0ea6b3fd', 'artist', 'dc89c826-c298-48c8-aa05-50e77d85264a');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'johnny-pacheco') AND locale = 'es'), 'ea93bbab-4bbe-495e-9891-ee7f08af959c', 'artist', 'e8ba0f32-1d96-494d-9861-b1dc3937331e');
