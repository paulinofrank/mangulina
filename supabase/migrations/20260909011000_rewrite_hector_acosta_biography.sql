...
SELECT id, 'b0d8fb30-257e-4072-acd9-dcc22829d335', 'artist', '73032c71-e46c-45b1-b02c-8f4de18426ad' FROM editorial_documents
 WHERE owner_artist_id='dee014d6-cb3c-4abb-9262-165538277a0d' AND locale='en' AND document_type='artist_biography';
INSERT INTO editorial_entity_references (editorial_document_id, occurrence_id, entity_type, target_artist_id)
SELECT id, 'c144e306-25f0-44ba-9d04-7ecdd48e52f2', 'artist', '3422883e-7048-48af-bb03-c68c8c557ee4' FROM editorial_documents
 WHERE owner_artist_id='dee014d6-cb3c-4abb-9262-165538277a0d' AND locale='en' AND document_type='artist_biography';
INSERT INTO editorial_entity_references (editorial_document_id, occurrence_id, entity_type, target_artist_id)
SELECT id, '3e6618a2-e4d2-4ee6-8ae3-ac441157ce82', 'artist', '1519cbca-ae0a-4ede-924b-244a49c9024e' FROM editorial_documents
 WHERE owner_artist_id='dee014d6-cb3c-4abb-9262-165538277a0d' AND locale='en' AND document_type='artist_biography';
INSERT INTO editorial_entity_references (editorial_document_id, occurrence_id, entity_type, target_artist_id)
SELECT id, 'b5bf1105-6b09-4eb3-a8f9-81294ccd44b9', 'artist', 'e8ba0f32-1d96-494d-9861-b1dc3937331e' FROM editorial_documents
 WHERE owner_artist_id='dee014d6-cb3c-4abb-9262-165538277a0d' AND locale='en' AND document_type='artist_biography';
...
INSERT INTO editorial_entity_references (editorial_document_id, occurrence_id, entity_type, target_artist_id)
SELECT id, '872cc816-d649-4ab7-b257-29beea20475e', 'artist', '73032c71-e46c-45b1-b02c-8f4de18426ad' FROM editorial_documents
 WHERE owner_artist_id='dee014d6-cb3c-4abb-9262-165538277a0d' AND locale='es' AND document_type='artist_biography';
INSERT INTO editorial_entity_references (editorial_document_id, occurrence_id, entity_type, target_artist_id)
SELECT id, '29654614-021f-4ead-b5a7-b3f4a25911ac', 'artist', '3422883e-7048-48af-bb03-c68c8c557ee4' FROM editorial_documents
 WHERE owner_artist_id='dee014d6-cb3c-4abb-9262-165538277a0d' AND locale='es' AND document_type='artist_biography';
INSERT INTO editorial_entity_references (editorial_document_id, occurrence_id, entity_type, target_artist_id)
SELECT id, '5a50df71-890e-4d7e-87ea-abb0d61ee789', 'artist', '1519cbca-ae0a-4ede-924b-244a49c9024e' FROM editorial_documents
 WHERE owner_artist_id='dee014d6-cb3c-4abb-9262-165538277a0d' AND locale='es' AND document_type='artist_biography';
INSERT INTO editorial_entity_references (editorial_document_id, occurrence_id, entity_type, target_artist_id)
SELECT id, 'dc9a9ce5-ed5a-4f7b-ae76-1046c7a2c311', 'artist', 'e8ba0f32-1d96-494d-9861-b1dc3937331e' FROM editorial_documents
 WHERE owner_artist_id='dee014d6-cb3c-4abb-9262-165538277a0d' AND locale='es' AND document_type='artist_biography';
