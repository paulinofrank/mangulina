...
-- Rewrite the catalogue entry for Pepe Rosario.
--
...
At the time of his death the stations were playing Las Locas and Te Seguiré Queriendo, both in his voice. The sound the country first recognised as Los Hermanos Rosario was his.
...
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'pepe-rosario') AND locale = 'en'), '61023b85-d871-429c-941c-6a58be01db6f', 'artist', '6fc762d4-96b8-4ecf-aca8-fdf52936658e');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'pepe-rosario') AND locale = 'en'), '63c2f0da-bdf5-43c3-ad10-21db01acdd80', 'artist', '6fb033f0-4f8b-4101-a67d-1d445f316dc4');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'pepe-rosario') AND locale = 'en'), 'b76e6e36-b8d5-4c61-a76c-624b4de9fe34', 'artist', '3422883e-7048-48af-bb03-c68c8c557ee4');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'pepe-rosario') AND locale = 'es'), '7810cb2e-c384-4404-afc5-85364041b356', 'artist', '6fb033f0-4f8b-4101-a67d-1d445f316dc4');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'pepe-rosario') AND locale = 'es'), 'db7bd031-d00f-46d4-8cb4-4e633c5a5329', 'artist', '3422883e-7048-48af-bb03-c68c8c557ee4');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'pepe-rosario') AND locale = 'es'), 'dfb175c0-53dc-4632-afe8-57e4f0c5ca14', 'artist', '6fc762d4-96b8-4ecf-aca8-fdf52936658e');
