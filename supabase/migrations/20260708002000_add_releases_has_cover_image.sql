...
COMMENT ON COLUMN public.releases.has_cover_image IS
  'True when cover-art/150px/{id}.webp exists and frontend views should request release cover art.';

DROP FUNCTION IF EXISTS public.get_release_summaries_by_ids(uuid[]);
