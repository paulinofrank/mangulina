-- Add formation_year and dissolution_year columns to artists table
ALTER TABLE public.artists
  ADD COLUMN IF NOT EXISTS formation_year integer NULL,
  ADD COLUMN IF NOT EXISTS dissolution_year integer NULL;

-- Update get_artist_profile_page RPC procedure to expose formation_year and dissolution_year
...
AS $$
  SELECT jsonb_build_object(
    ...
    'dissolution_year', a.dissolution_year,
