...
-- su velatorio.
--
-- ARAMIS CAMILO NO SE ENLAZA PORQUE NO ESTÁ EN EL CATÁLOGO. Es la segunda ficha
-- de hoy en que hace falta -- también salió con Yoskar Sarante -- y eso lo
-- convierte en una ausencia con prioridad.
--
