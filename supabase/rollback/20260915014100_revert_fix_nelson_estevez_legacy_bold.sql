...
Estévez has spent four decades making those decisions, and a large part of what a Dominican audience can now hear from the eighties and nineties exists because J&N put it on tape.', bio_es = 'Nelson Estévez es un ejecutivo discográfico y productor dominicano. Con Juan Hidalgo fundó y ha dirigido J&N Records por más de cuarenta años: la J y la N del nombre son Juan y Nelson.
