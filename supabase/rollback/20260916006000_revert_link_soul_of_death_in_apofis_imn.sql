...
-- Revierte 20260916006000_link_soul_of_death_in_apofis_imn.sql restaurando los documentos anteriores.
...
Apofis Imn appears both in the list of Dominican rock and metal bands compiled by the Enciclopedia Rock Dominicano and in the international black metal archives, where it is listed as active.', bio_es = 'Apofis Imn es una banda dominicana de black metal fundada en Santo Domingo con el nombre de Amon, que en sus últimos años ha estado radicada en Buenos Aires, Argentina.
