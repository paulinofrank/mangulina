...
-- Reverts 20260908003500_rewrite_yoskar_sarante_biography.sql.
--
...
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'yoskar-sarante') AND locale = 'en'), '367e4394-2653-4c73-bda9-2c65dc176418', 'artist', '73691e65-206a-4c71-9b5f-8689f15b2584');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'yoskar-sarante') AND locale = 'en'), '7df5c7e6-6133-427f-add5-f4a8b36c936e', 'artist', 'e566c763-02c1-4f96-8a82-edbba9fc0bb2');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'yoskar-sarante') AND locale = 'es'), '955177dd-8f02-469b-a3f8-38371ee460ae', 'artist', '73691e65-206a-4c71-9b5f-8689f15b2584');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'yoskar-sarante') AND locale = 'es'), 'f1502d94-940a-44f6-bb4e-033e76a24410', 'artist', 'e566c763-02c1-4f96-8a82-edbba9fc0bb2');
